...
const ProduitForm = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values, { resetForm }) => {
            ...
            } else if (subCategory === IMMOBILIER) {
            ...
            } else if (subCategory === VETEMENT_CHAUSSURES) {
